...
src = open("Daily_cache_v25.py", encoding="utf-8").read()
...
assert "USDINR" in u9, "sole series on an exchange = completeness unverifiable"
print(f"   USDINR PASS_UNVERIFIED: {u9['USDINR']['warnings'][0][:66]}")
...
# ============ 11. ETA ============
print("\n11. ETA")
src25 = open("Daily_cache_v25.py", encoding="utf-8").read()
