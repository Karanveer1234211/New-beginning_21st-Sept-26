@echo off
REM ===================================================================
REM  Run after ANY change to features_daily.py or Daily_cache_v26.py.
...
python "%~dp0test_cache_v26.py" && python "%~dp0test_panel.py" && python "%~dp0test_reconcile.py" || set FAILED=1
